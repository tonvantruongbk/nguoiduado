...
namespace nguoiduado.Code
{
    public class Utils
    {
        ...
        /// <returns></returns>
        public static string EncodePassword(string toEncrypt, bool useHashing)
        {
            byte[] keyArray;
        ...
        public static class Constants
        {
            ...
            public const string Url = "http://localhost:1931";
